package com.sscctv.seeeyesonvif.__Not_Used.Rtsp.Video;
...
//                mMeidaCodec.setVideoScalingMode(MediaCodec.VIDEO_SCALING_MODE_SCALE_TO_FIT_WITH_CROPPING);
                ...
                outputFormat = mMeidaCodec.getOutputFormat();
                Log.d(TAG, "MediaFormat Output: " + outputFormat);
                isStop = false;
                ...
                try {
                    ...
                    if ((startKeyFrame || framType == 7 || framType == 8) && mMeidaCodec != null) {
                        ...
                        if (inputBufferIndex > 1) {
                            ...
                            mMeidaCodec.queueInputBuffer(inputBufferIndex, 0, tmpByte.length, timeStamp, 0);
...
//					Log.e(tag,"Wait the buffer come..");
    ...
    private void decodeSPS() {
        ...
        Log.d(TAG, "H264Stream - The picWidth = " + picWidth + " ,the picHeight = " + picHeight);
//		Log.e(tag, "The picWidth = " + picWidth + " ,the picHeight = " + picHeight);
    ...
    public void setSurfaceView(SurfaceView s) {
        ...
        if(Build.VERSION.SDK_INT > 15) {
            ...
            Log.d(TAG, "H264Stream - The Platform not support the hardware decode H264!");
        }
    }
