...
public class SubnetUtils {
	...
	/**
	 * Returns <code>true</code> if the return value of {@link SubnetInfo#getAddressCount()} includes the network
	 * address and broadcast addresses.
	 * 
	 * @since 2.2
	 */
	...
	public final class SubnetInfo {
		...
		public int getNetmaskPrefix() {
			return pop(toInteger(format(toArray(netmask()))));
		}
	}
	...
	/*
	 * Convenience method to extract the components of a dotted decimal address and pack into an integer using a regex
	 * match
	 */
	...
	/*
	 * Convenience function to check integer boundaries. Checks if a value x is in the range (begin,end]. Returns x if
	 * it is in range, throws an exception otherwise.
	 */
	...
	/*
	 * Count the number of 1-bits in a 32-bit integer using a divide-and-conquer strategy see Hacker's Delight section
	 * 5.1
	 */
	int pop(int x) {
		x = x - ((x >>> 1) & 0x55555555);
	...
	/*
	 * Convert two dotted decimal addresses to a single xxx.xxx.xxx.xxx/yy format by counting the 1-bit population in
	 * the mask address. (It may be better to count NBITS-#trailing zeroes for this case)
	 */
